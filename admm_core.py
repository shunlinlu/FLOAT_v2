...
class Masking(object):
    ...
    def __init__(self, optimizer, prune_rate_decay, prune_rate=0.5, prune_mode='magnitude', growth_mode='momentum', redistribution_mode='momentum', verbose=True, fp16=False):
        growth_modes = ['random', 'momentum', 'momentum_neuron', 'filter_momentum', 'channel_momentum ', 'column_momentum', 'block_momentum']
        ...
        self.increment = 0.2
        self.tolerance = 0.02
        #urgent:Souvik changed the following value from None to 100
        self.prune_every_k_steps = None
        self.half = fp16
        self.name_to_32bit = {}

        #Souvik: Added this variable to choose if we want to apply the 
        ...
        self.rho = 0.0001 # We hard code the rhos
        ###############################################
